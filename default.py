...
f.write("body {background-image:url('http://subtlepatterns.com/patterns/binding_dark.png');background-color:#333333;}\n")
...
f.write('}\n')
f.write('</script>\n')
f.write('<div id="Date" style="height:65px;width:300px;float:right;padding-right:5%;">\n')
f.write('<p class="date">Last Updated: '+time.strftime('%d %B %Y')+'</p>\n')
f.write('</div>\n')
f.write('<div id="search" style="height:65px;width:300px;float:left;padding-left:5%;">\n')
...
f.write('</div>\n')
f.write('<div id="Heading" style="height:65px;width:100%;margin-left: auto;margin-right: auto ;">\n')
